...
const Planning = () => {
  ...
  return (
    <section className="relative max-w-[2000px] mx-auto bg-(--bg-secondary) text-(--text-primary) pt-20 overflow-hidden">
      <div className="max-w-[1440px] mx-auto lg:h-[500px] lg:px-8 px-4">
        <div className="relative w-full h-[300px] z-30 lg:h-[400px] mb-12 lg:mb-16">
          <Image
            src={
              theme === "dark"
                ? "/catering/cateringPlanning.svg"
          ...
          <div className="absolute font-bebas-neue flex flex-col gap-4 max-w-3xl mx-auto text-center items-center justify-center inset-0">
            <h2 className="lg:text-[72px] text-[40px]  lg:text-6xl font-bold text-white">
              Planning an event? Let us handle the hookah catering.
            </h2>
            <div className="flex justify-center  ">
              <Link
                href={"/rentals"}
                className="relative cursor-pointer bg-[#F5C400] text-black rounded-full py-3 pl-8 pr-16 hover:bg-[#FFD700] transition-all duration-300 group"
              >
                <span className="font-bebas-neue text-lg md:text-xl tracking-wide">
                  RENT A HOOKAH
                </span>
