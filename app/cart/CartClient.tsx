...
const CartClient = () => {
  ...
  const cartImage =
    theme === "dark" ? "/cart/whiteCart.svg" : "/cart/grayCart.svg";
  const hookahImage =
    theme === "dark" ? "/layout/hookahBlack.svg" : "/layout/hookah.svg";
  const cloudImage =
            ...
            <div className="flex-1">
              {cartItems.length === 0 ? (
                ...
                <>
                  {/* Table Header */}
                  <div
                    className={`grid grid-cols-12 gap-4 pb-4 border-b ${theme === "dark" ? "border-black" : "border-gray-200"} font-semibold text-sm`}
                  >
                        ...
                        <div className="col-span-3">
                          <div className="flex items-center  justify-center">
                            <div className="flex items-center p-1 border-2 border-primary rounded-[27px] justify-around gap-1 w-24 sm:w-32">
                              ...
                              <span className="flex-1 text-center font-medium text-xs sm:text-sm">
                                {item.quantity}
                              </span>
                              <button
                                onClick={() =>
