...
export const metadata: Metadata = {
  ...
  description: 'Browse our premium hookah collection for rent. Perfect for events, parties, and special occasions. Professional delivery, setup, and premium flavors included.',
  keywords: [
    'hookah rentals',
    'rent hookah',
    'hookah for events',
  ...
  twitter: {
    ...
    title: 'Hookah Rentals - Premium Hookahs for Events & Parties | Book Now',
    description: 'Browse our premium hookah collection for rent. Perfect for events, parties, and special occasions. Professional delivery and setup included.',
