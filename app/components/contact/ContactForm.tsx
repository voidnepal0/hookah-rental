      ...
      <div className="flex  lg:items-center  justify-between flex-col lg:flex-row  gap-8">
        ...
        <div className="w-full lg:w-5/3">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mt-5">
            <div>
              <label className="block font-poppins text-[16px] ">Full Name *</label>
              <input
                type="text"
                name="fullName"
            ...
            <div>
              <label className="block font-poppins text-[16px] ">Email *</label>
              <input
                type="email"
                name="email"
            ...
            <div>
              <label className="block font-poppins text-[16px] ">Phone Number *</label>
              <input
                type="tel"
                name="phoneNumber"
            ...
            <div>
              <label className="block font-poppins text-[16px] ">Message *</label>
              <textarea
                name="message"
        ...
        <div className="flex-1  lg:flex-initial lg:mt-20 mt-0  text-black overflow-hidden w-full">
          <div className="bg-primary flex justify-between items-center w-full  rounded-[24px] px-8 py-12 relative lg:h-[500px]">
            ...
            <div className="absolute -top-20 -right-15 pointer-events-none">
              <Image 
                src={theme === 'dark' ? '/contact/blackcloud.svg' : '/contact/whitecloud.svg'} 
            ...
            <div className="absolute -bottom-5 right-0 pointer-events-none">
              <Image 
                src={theme === 'dark' ? '/contact/blackhookah.svg' : '/contact/whitehookah.svg'} 
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div>
                <h3 className="font-bebas-neue text-[24px] ">OPENING HOURS</h3>
                <div className= 'flex items-center gap-2'>
                  <ClockIcon className='w-5 h-5' />
                  <p className="font-poppins text-[16px]">9AM - 5PM  (Sunday - Friday)</p>
                </div>
              </div>
